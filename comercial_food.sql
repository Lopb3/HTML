...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2024 a las 02:16:55
...
CREATE TABLE `categoria` (
  ...
  `obsevaciones` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `empleado` (
  ...
  `apellido2` varchar(25) NOT NULL,
  `tipo_documento` enum('CC','CE','NIT','RUT') DEFAULT NULL,
  `no_documenton` varchar(25) NOT NULL,
  `sexo` enum('marculino','femenino') DEFAULT NULL,
  `direccion` varchar(50) NOT NULL,
  `ciudad` varchar(20) NOT NULL,
  `edad` int(11) NOT NULL CHECK (`edad` >= 18),
  `telefono` varchar(25) NOT NULL,
  `fecha_ingreso` date DEFAULT curdate(),
  `estado_civil` enum('soltero','casado','divociado','union libre','viudo') DEFAULT NULL,
