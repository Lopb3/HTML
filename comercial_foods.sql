...
CREATE TABLE `empleado` (
  ...
  `nivel_estidios` enum('primaria','bachillerato','tecnico','tecnologo','profecional','otro') DEFAULT NULL,
  `eps` enum('sanitas','sura','capital salud','nueva eps','compensar','famisanar','aliansalud') DEFAULT NULL,
  `pensiones` enum('coldonfos','proteccion','porvenir','skandia') DEFAULT NULL,
